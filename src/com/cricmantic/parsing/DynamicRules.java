...
public class DynamicRules {
	...
	public void inferRules() throws IOException {
		...
		String content = null;
		String fileName="C:\\Users\\Hamza\\workspace\\pro-master\\pro-master\\src\\Archive\\FileNo.txt";
		FileInputStream fstream = new FileInputStream(fileName);
		BufferedReader br = new BufferedReader(new InputStreamReader(fstream));
		//Read File Line By Line
		content = br.readLine(); 
		fileNo=Integer.parseInt(content);
		fileName = "C:\\Users\\Hamza\\workspace\\pro-master\\pro-master\\src\\Archive\\cricmantic"+Integer.toString(fileNo)+".owl";
		model.read(fileName);
		...
		{	QueryString="PREFIX "+rdf+"\n"+"PREFIX "+uri+"\n"+
				"SELECT * where { \n"+
				"demo:"+tokenList.get(i)+ " demo:team1 ?s."+		
		...
		QueryString="PREFIX "+rdf+"\n"+"PREFIX "+uri+"\n"+
				...
				"demo:"+tokenList.get(i)+ " demo:team1 ?t."+
				"?t demo:hasPlayer ?player."+
				"?ball demo:ballBatsman ?player."+
				"?ball demo:instanceHasMatch demo:"+tokenList.get(i)+"."+
		...
		QueryString="PREFIX "+rdf+"\n"+"PREFIX "+uri+"\n"+
				"SELECT (sum(?score)as ?s) where { \n"+
				"demo:"+tokenList.get(i)+ " demo:team2 ?t."+
				"?t demo:hasPlayer ?player."+
				"?ball demo:ballBatsman ?player."+
				"?ball demo:instanceHasMatch demo:"+tokenList.get(i)+"."+
				"?ball demo:teamScore ?score."+
		...
		if(Integer.parseInt(score1)>Integer.parseInt(score2))
		{
			...
			Match.addLiteral(pr7, team1+" won by "+Integer.toString((10-Integer.parseInt(wik1)))+" wiks"
					+" and "+Integer.toString((Integer.parseInt(score1)-(Integer.parseInt(score2))))+" runs");
		...
		else if(Integer.parseInt(score1)<Integer.parseInt(score2))
		{
			...
			Match.addLiteral(pr7, team2+" won by "+Integer.toString((10-Integer.parseInt(wik2)))+" wiks"
					+" and "+Integer.toString((Integer.parseInt(score2)-(Integer.parseInt(score1))))+" runs");
		}
		...
		out.close();	
		fileName="C:\\Users\\Hamza\\workspace\\pro-master\\pro-master\\src\\Archive\\FileNo.txt";
		out = new FileWriter(fileName );
		fileNo=fileNo+1;
