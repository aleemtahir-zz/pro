...
public class matchServlet extends HttpServlet {
	...
	private void loadPage(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * String param1 = "?team"; String query = "prefix " + uri +
		 * "select distinct ?team where { " + "?team demo:hasPlayer ?player .}";
		 * 
		 * try { list1 = com.cricmantic.functions.graphQuery.getOneList(query,
		 * param1);
		 * 
