...
public class teamServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!(TeamName.equals(null))) {
				...
				String query = "prefix " + uri + "select distinct " + param1 + " where { " + "demo:" + TeamName
						+ " demo:hasPlayer ?player .}";
				...
				*/
				...
				query = "prefix " + uri + "select (count(?ball) as ?count) where { " + "demo:" + TeamName
						+ " demo:hasPlayer ?player." + "?ball demo:ballBowler ?player." + "?ball demo:event ?event."
	...
	private void loadPage(HttpServletRequest request, HttpServletResponse response)
		...
		String param1 = "?team";
		String query = "prefix " + uri + "select distinct ?team where { " + "?team demo:hasPlayer ?player .}";
